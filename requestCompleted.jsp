...
try
{
	...
	PreparedStatement pst = con.prepareStatement("select* from requestvaccination where adminbank_id='"+admin_bank+"' and status='completed'");
...
<td><a href="requestForVaccineDelete.jsp?mail=<%=rs.getString(3)%>">Delete</a></td>
</tr>
<%
}
}
